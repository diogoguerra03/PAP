...
public class AjudaPerfilSessao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajuda_perfil_sessao);

        getSupportActionBar().setTitle(R.string.terminarSessão);
