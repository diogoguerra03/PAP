...
public class Quinta extends AppCompatActivity {
    ...
    public void excluirTarefa(final RecyclerView.ViewHolder viewHolder){
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Quinta.this);
        ...
        alertDialog.setPositiveButton(R.string.confirmar, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                horarioQuintaRef.child(horario.getId()).removeValue();
    ...
    private void adicionarHorario(){
        ...
        campoHrInicial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Quinta.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                ...
                if (!disciplinaP.isEmpty()){
                    if (!salaP.isEmpty()){
                        if (HrInicialP.equals("Hora Inicial") && HrFinalP.equals("Hora Final")){
                            Toast.makeText(Quinta.this, R.string.digitarHora, Toast.LENGTH_LONG).show();
                        }else{
                            String emailUtilizador = auth.getCurrentUser().getEmail();
                            String idUtilizador = Base64Custom.codificarBase64(emailUtilizador);
                        ...
                        Toast.makeText(Quinta.this, R.string.digitarSala, Toast.LENGTH_LONG).show();
                    }

                }else{
                    Toast.makeText(Quinta.this, R.string.digitarDisciplina, Toast.LENGTH_LONG).show();
                }
