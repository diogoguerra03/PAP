...
public class AjudaHorarioCriar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajuda_horario_criar);

        getSupportActionBar().setTitle(R.string.criarAula);
