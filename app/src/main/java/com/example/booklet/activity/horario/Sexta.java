                ...
                if (!disciplinaP.isEmpty()){
                    if (!salaP.isEmpty()){
                        if (!HrInicialP.isEmpty() && !HrFinalP.isEmpty()){
                            ...
                            Toast.makeText(Sexta.this, "Digite a hora corretamente", Toast.LENGTH_LONG).show();
                        }
                    }else{
                        Toast.makeText(Sexta.this, "Digite a descrição", Toast.LENGTH_LONG).show();
                    }

                }else{
                    Toast.makeText(Sexta.this, "Digite a tarefa", Toast.LENGTH_LONG).show();
                }
