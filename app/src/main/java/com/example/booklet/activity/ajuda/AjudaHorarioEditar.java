...
public class AjudaHorarioEditar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajuda_horario_editar);

        getSupportActionBar().setTitle(R.string.EditarAula);
