...
public class Terca extends AppCompatActivity {
    ...
    private DatabaseReference horarioTercaRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterHorario = new AdapterHorario(horarios, Terca.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(Terca.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
        ...
        floatingActionButton = findViewById(R.id.fabTerca);
    ...
    public void excluirTarefa(final RecyclerView.ViewHolder viewHolder){
        ...
        alertDialog.setPositiveButton(R.string.confirmar, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                horarioTercaRef = firebaseRef.child("horario")
                        .child(idUtilizador).child("terça");

                horarioTercaRef.child(horario.getId()).removeValue();
    ...
    private void adicionarHorario(){
        AlertDialog.Builder myDialog = new AlertDialog.Builder(Terca.this);
        LayoutInflater inflater = LayoutInflater.from(Terca.this);
    ...
    public void recuperarHoraio(){
        ...
        valueEventListenerHorario = horarioTercaRef.addValueEventListener(new ValueEventListener() {
            @Override
                ...
                if (!disciplinaP.isEmpty()){
                    if (!salaP.isEmpty()){
                        if (!HrInicialP.isEmpty() && !HrFinalP.isEmpty()){
                            ...
                            horarioTercaRef.child(horario.getId()).updateChildren(hashDisciplina);
                            horarioTercaRef.child(horario.getId()).updateChildren(hashSala);
