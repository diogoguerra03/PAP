...
public class AjudaHorarioEliminar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajuda_horario_eliminar);

        getSupportActionBar().setTitle(R.string.EliminarAula);
