...
import com.example.booklet.activity.PrincipalActivityProfessor;
import com.example.booklet.activity.RegistoAlunoActivity;
import com.example.booklet.activity.RegistoProfessorActivity;
...
public class ProfessorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textRegisto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), RegistoProfessorActivity.class);
    ...
    public void abrirTelaPrincipal(){
        startActivity(new Intent(getActivity(), PrincipalActivityProfessor.class));
        getActivity().finish();
    }
